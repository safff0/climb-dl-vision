...
from data.color_crops_dataset import compute_class_weights, get_color_dataloader
from models import create_model
from pipelines import register_pipeline
from pipelines.eva02_color.validate import evaluate_macro_f1
...
@register_pipeline("eva02_color", PipelineMode.TRAIN)
def run_train(model_name: str, output: str):
    ...
    train_loader = get_color_dataloader(model_name, Split.TRAIN)
    val_loader = get_color_dataloader(model_name, Split.VALID)
