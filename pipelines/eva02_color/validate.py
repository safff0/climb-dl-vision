...
from data.color_crops_dataset import get_color_dataloader
...
@register_pipeline("eva02_color", PipelineMode.VALIDATE)
def run_validate(model_name: str, weights: str):
    ...
    loader = get_color_dataloader(model_name, Split.VALID)
